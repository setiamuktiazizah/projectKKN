<?php 
    ...
    // $peran    = $_POST['peran'];
		...
		$sql = "insert into user values(null, '$nama', '$username', '$password')";
        ...
        <form role="form" method="post">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukan Password" name="password" required>
            </div>
            <!-- <div class="form-group">
